...
<h1 align="center">J S'GENT · intelligence in orbit.</h1>
...
| :-- | :-- |
| `01 / j-sgent` | an orbital AI system for a single, evolving intelligence |
| `02 / systems` | resilient tools, APIs, and architecture experiments |
...
```text
LANGUAGE    → Python
INTERESTS   → agents · memory · interfaces · mathematical systems
PRINCIPLE   → private purpose, public craft
```

<details>
<summary><b>⌘ Why the empty fields?</b></summary>
<br />

The profile keeps the visible stack intentionally compact. Add a technology only when it represents work you would like to discuss.
